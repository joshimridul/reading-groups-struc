...
loc full "meanpeerscore_bl sdpeerscore_bl dev_med_bl classsize" 
...
gen std_score_blXMI_EL = std_score_bl*MISSING_EL
...
loc full "meanpeerscore_bl sdpeerscore_bl dev_med_bl classsize" 
		...
		forvalues s = 1/7 {
			...
			*reghdfe std_score_el `indep' `exp' std_score_bl i.grade, a(strata) vce(clus ggroup)
			reghdfe std_score_el `indep' `exp' std_score_bl MISSING_EL std_score_blXMI_EL, a(strata) vce(clus ggroup)
...
file open let using "${outdir}/distance_median_sd_bl_sep.tex", write replace	
