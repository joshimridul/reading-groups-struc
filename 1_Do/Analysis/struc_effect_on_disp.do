...
file open let using "${outdir}/eff_on_disp.tex", write replace	
	file write let "\begin{center} " _n
	file write let "\caption{\small Effect on absolute deviation in test scores from reading group mean} " _n
