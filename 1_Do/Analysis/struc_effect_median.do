...
loc full "meanpeerscore dev_med_ehat classsize" 
		...
		forvalues s = 1/4 {
			...
			*reghdfe std_comp_score_el `indep' `exp' std_comp_score_bl, a(constituency) vce(clus academycode)
...
file open let using "${outdir}/distance_median.tex", write replace	
