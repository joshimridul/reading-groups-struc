...
loc full "meanpeerscore peer_hatXind_hat realised_level levelXind_hat logclasssize logclassizeXind_hat" 
		...
		forvalues s = 1/8 {
			...
			if `s' == 2 {
				loc indep "meanpeerscore peer_hatXind_hat"
				loc exp "exp_meanpeerscore"
			} 
		    if `s' == 3 {
		    ...
		    if `s' == 6 {
				loc indep "logclasssize logclassizeXind_hat"
				loc exp "exp_logclasssize"
			} 
		    if `s' == 7 {
				loc indep "meanpeerscore realised_level logclasssize"
				loc exp "exp_meanpeerscore exp_level exp_logclasssize"
			} 
		    if `s' == 8 {
				loc indep "meanpeerscore realised_level logclasssize peer_hatXind_hat levelXind_hat logclassizeXind_hat"
				loc exp "exp_meanpeerscore exp_level exp_logclasssize"
			} 
...
file open let using "${outdir}/structural_testscores_log.tex", write replace	
