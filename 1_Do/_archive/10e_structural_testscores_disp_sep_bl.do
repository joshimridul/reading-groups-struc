...
file open let using "${outdir}/structural_testscores_disp_sep_bl.tex", write replace	
	file write let "\begin{center} " _n
	file write let "\caption{\small Effect on test scores (by grade groups; dispersion)} " _n
