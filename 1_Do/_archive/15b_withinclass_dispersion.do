...
file open let using "${outdir}/structural_dispersion_testscores_rev.tex", write replace	
	...
	*file write let "`S'  \\" _n
	...
	file write let "\multicolumn{3}{l}{\textbf{\textit{Panel B: Experiment 2 (Liberia, grades 1-2)}}} \\" _n
	...
	file write let "\multicolumn{3}{l}{\textbf{\textit{Panel C: Experiment 2 (Liberia, grades 3-4)}}} \\" _n
