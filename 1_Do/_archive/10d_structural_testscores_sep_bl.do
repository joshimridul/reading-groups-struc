...
loc full "meanpeerscore_bl realised_level levelXbl classsize" 
		...
		forvalues s = 1/6 {
		    ...
		    if `s' == 6 {
				loc indep "meanpeerscore_bl realised_level classsize levelXbl"
				loc exp "exp_meanpeerscore_bl exp_level exp_classsize"
			} 
...
file open let using "${outdir}/structural_testscores_sep_bl.tex", write replace	
